...
#+garnet-debug (defparameter Scrolling-Labeled-Box-win NIL)
#+garnet-debug (defparameter Scrolling-Labeled-Box-top-agg NIL)
#+garnet-debug (defparameter Scrolling-Labeled-Box-Obj NIL)
