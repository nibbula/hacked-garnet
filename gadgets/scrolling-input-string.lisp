...
#+garnet-debug (defparameter Scrolling-Input-String-Win NIL)
#+garnet-debug (defparameter Scrolling-Input-String-Top-Agg NIL)
#+garnet-debug (defparameter Scrolling-Input-String-Obj NIL)
