...
#+garnet-debug (defparameter *MOTIF-FONT-TO-SWAP* (create-instance NIL opal:font))
#+garnet-debug (defvar motif-family-text NIL)
#+garnet-debug (defvar motif-face-text NIL)
#+garnet-debug (defvar motif-size-text NIL)
#+garnet-debug (defvar motif-combo-text NIL)
...
(defun Motif-Menubar-Go (&key dont-enter-main-event-loop)
  ...
  (create-instance 'DEMO-MOTIF-MENUBAR MOTIF-MENUBAR
	...
	((:fixed motif-fixed-fn)(:serif motif-serif-fn)(:sans-serif motif-sans-serif-fn)))
       (:face motif-face-fn
